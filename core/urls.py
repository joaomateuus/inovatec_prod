...
router.register(r'vistorias_agendadas', views.VistoriaAgendadaViewSet, basename='vistorias')
router.register(r'vistorias_realizadas', views.VistoriaRealizadaViewSet, basename='vistorias')
